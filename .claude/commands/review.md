Dispare o agente `reviewer` (D:/Fabio/2b-projects/brain/_bks-ai/agents/reviewer.md) em invocação SEPARADA da sessão
de implementação — read-only, nunca quem escreveu o código revisando a si mesmo.

Argumento esperado: qual repo revisar (D:/Fabio/2b-projects/repos/{categoria}/{projeto}). Se não informado, pergunte
...
1. O projeto tem manifesto em {repo}/.claude/multiagente.md? Se não, PARE e oriente a criar a
   partir de D:/Fabio/2b-projects/brain/_bks-ai/templates/manifesto-projeto.md antes de revisar código crítico.
...
- D:/Fabio/2b-projects/brain/_bks-ai/references/checklist-revisao-critica.md
